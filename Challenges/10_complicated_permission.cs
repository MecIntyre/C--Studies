/* Implement business rules that restrict access to users based on their permissions and their level. 
   ...
   5. If the user is not an Admin or a Manager, output the message:
      Output: You do not have sufficient privileges. 
   6. When you run the code, including the sample data from Step 2, you should see the following output:
      Output: Welcome, Admin user. */
